...
class GoogleCalendarService:
    ...
    def get_upcoming_events(self, max_results=10, time_min=None):
        ...
        if time_min is None:
            ...
            time_min = time_min.isoformat() + ('Z' if time_min.tzinfo is None else '')
    ...
    def find_free_time(self, duration_minutes=60, days_ahead=7):
        ...
        time_min = datetime.now(self.local_timezone)
        ...
        try:
            ...
            for day in range(days_ahead):
                ...
                day_end = day_start.replace(hour=17)  # End at 5 PM
    ...
    def handle_request(self, message, context=None):
        ...
        try:
            ...
            if free_slots:
                ...
                for slot in free_slots[:8]:  # Show first 8 slots
